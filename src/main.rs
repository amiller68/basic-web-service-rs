...
async fn main() {
    ...
    use basic_web_service::app::{AppState, Config};
    ...
    basic_web_service::register_panic_logger();
    basic_web_service::report_version();
    ...
    let (graceful_waiter, shutdown_rx) = basic_web_service::graceful_shutdown_blocker();
    let mut handles = Vec::new();

    let server = basic_web_service::server(
